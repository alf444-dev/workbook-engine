...
code=0
for t in test_bundle_ids test_langue test_profil test_plan test_generation test_decisions test_server test_admin test_livraison test_bout_en_bout test_promesse; do
  printf '%-18s ' "$t"
