...
code=0
for t in test_bundle_ids test_repetition test_langue test_profil test_plan test_generation test_decisions test_server test_admin test_livraison test_bout_en_bout test_promesse test_securite test_concurrence test_manuscrits test_console test_comparer test_relecture test_langues test_voix; do
  printf '%-18s ' "$t"
